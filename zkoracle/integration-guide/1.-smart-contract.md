...
* [**zkAutomation**](../zkoracle-standards/zkautomation/): A standard adopted by all zkOracle nodes. It will help you submit computation results and proofs (verified onchain by universal verifier smart contract). Requirements can be found under zkAutomation's user guide.
